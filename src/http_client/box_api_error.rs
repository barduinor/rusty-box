...
pub struct BoxAPIError {
    ...
    pub context_info: Option<Box<BoxAPIErrorContextInfo>>,
...
#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct BoxAPIErrorContextInfo {
    /// More details on the error.
    #[serde(rename = "message", skip_serializing_if = "Option::is_none")]
    pub message: Option<String>,
}

impl BoxAPIErrorContextInfo {
    /// A free-form object that contains additional context about the error. The possible fields are defined on a per-endpoint basis. `message` is only one example.
    pub fn new() -> BoxAPIErrorContextInfo {
        BoxAPIErrorContextInfo { message: None }
    }
}
