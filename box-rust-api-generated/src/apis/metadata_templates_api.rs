...
pub struct PostMetadataTemplatesSchemaParams {
    pub post_metadata_templates_schema_request:
        Option<crate::models::PostMetadataTemplatesSchemaRequest>,
}
...
pub struct PutMetadataTemplatesIdIdSchemaParams {
    ...
    /// The name of the metadata template
    pub template_key: String,
    pub a_metadata_template_update_operation:
        Option<Vec<crate::models::AMetadataTemplateUpdateOperation>>,
}
...
pub async fn delete_metadata_templates_id_id_schema(
    configuration: &configuration::Configuration,
    params: DeleteMetadataTemplatesIdIdSchemaParams,
) -> Result<(), Error<DeleteMetadataTemplatesIdIdSchemaError>> {
    ...
    let local_var_uri_str = format!(
        ...
        template_key = crate::apis::urlencode(template_key)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteMetadataTemplatesIdIdSchemaError> =
...
pub async fn get_metadata_templates(
    configuration: &configuration::Configuration,
    params: GetMetadataTemplatesParams,
) -> Result<crate::models::MetadataTemplates, Error<GetMetadataTemplatesError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.query(&[("metadata_instance_id", &metadata_instance_id.to_string())]);
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMetadataTemplatesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_metadata_templates_enterprise(
    configuration: &configuration::Configuration,
    params: GetMetadataTemplatesEnterpriseParams,
) -> Result<crate::models::MetadataTemplates, Error<GetMetadataTemplatesEnterpriseError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMetadataTemplatesEnterpriseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_metadata_templates_global(
    configuration: &configuration::Configuration,
    params: GetMetadataTemplatesGlobalParams,
) -> Result<crate::models::MetadataTemplates, Error<GetMetadataTemplatesGlobalError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMetadataTemplatesGlobalError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_metadata_templates_id(
    configuration: &configuration::Configuration,
    params: GetMetadataTemplatesIdParams,
) -> Result<crate::models::MetadataTemplate, Error<GetMetadataTemplatesIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMetadataTemplatesIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_metadata_templates_id_id_schema(
    configuration: &configuration::Configuration,
    params: GetMetadataTemplatesIdIdSchemaParams,
) -> Result<crate::models::MetadataTemplate, Error<GetMetadataTemplatesIdIdSchemaError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMetadataTemplatesIdIdSchemaError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_metadata_templates_schema(
    configuration: &configuration::Configuration,
    params: PostMetadataTemplatesSchemaParams,
) -> Result<crate::models::MetadataTemplate, Error<PostMetadataTemplatesSchemaError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostMetadataTemplatesSchemaError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn put_metadata_templates_id_id_schema(
    configuration: &configuration::Configuration,
    params: PutMetadataTemplatesIdIdSchemaParams,
) -> Result<crate::models::MetadataTemplate, Error<PutMetadataTemplatesIdIdSchemaError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PutMetadataTemplatesIdIdSchemaError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
