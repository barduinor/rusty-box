...
pub async fn delete_users_id_avatar(
    configuration: &configuration::Configuration,
    params: DeleteUsersIdAvatarParams,
) -> Result<(), Error<DeleteUsersIdAvatarError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteUsersIdAvatarError> =
...
pub async fn get_users_id_avatar(
    configuration: &configuration::Configuration,
    params: GetUsersIdAvatarParams,
) -> Result<std::path::PathBuf, Error<GetUsersIdAvatarError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUsersIdAvatarError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_users_id_avatar(
    configuration: &configuration::Configuration,
    params: PostUsersIdAvatarParams,
) -> Result<crate::models::UserAvatar, Error<PostUsersIdAvatarError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostUsersIdAvatarError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
