...
pub async fn get_metadata_query_indices(
    configuration: &configuration::Configuration,
    params: GetMetadataQueryIndicesParams,
) -> Result<crate::models::MetadataQueryIndices, Error<GetMetadataQueryIndicesError>> {
    ...
    local_var_req_builder =
        local_var_req_builder.query(&[("template_key", &template_key.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetMetadataQueryIndicesError> =
...
pub async fn get_search(
...
) -> Result<crate::models::GetSearch200Response, Error<GetSearchError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = trash_content {
        local_var_req_builder =
            local_var_req_builder.query(&[("trash_content", &local_var_str.to_string())]);
    }
    //
    ...
    //             &local_var_str
    //                 .into_iter()
    //                 .map(|p| ("mdfilters".to_owned(), p.to_string()))
    //                 .collect::<Vec<(std::string::String, std::string::String)>>(),
    //         ),
    //         _ => local_var_req_builder.query(&[(
    //             "mdfilters",
    ...
    if let Some(ref local_var_str) = include_recent_shared_links {
        local_var_req_builder = local_var_req_builder
            .query(&[("include_recent_shared_links", &local_var_str.to_string())]);
    }
...
pub async fn post_metadata_queries_execute_read(
...
) -> Result<crate::models::MetadataQueryResults, Error<PostMetadataQueriesExecuteReadError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostMetadataQueriesExecuteReadError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
