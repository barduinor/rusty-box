...
pub struct TrashFolder {
    ...
    pub path_collection: Box<crate::models::TrashFilePathCollection>,
    #[serde(rename = "created_by")]
    pub created_by: Box<crate::models::FolderAllOfCreatedBy>,
    #[serde(rename = "modified_by")]
    pub modified_by: Box<crate::models::FolderAllOfModifiedBy>,
    ...
    pub owned_by: Box<crate::models::FolderAllOfOwnedBy>,
...
impl TrashFolder {
    ...
    pub fn new(id: String, r#type: RHashType, name: String, description: String, size: i64, path_collection: crate::models::TrashFilePathCollection, created_by: crate::models::FolderAllOfCreatedBy, modified_by: crate::models::FolderAllOfModifiedBy, owned_by: crate::models::FolderAllOfOwnedBy, item_status: ItemStatus) -> TrashFolder {
        TrashFolder {
            id,
            etag: None,
            r#type,
