...
pub struct PutWebLinksIdAddSharedLinkRequestSharedLinkPermissions {
...
impl PutWebLinksIdAddSharedLinkRequestSharedLinkPermissions {
    pub fn new() -> PutWebLinksIdAddSharedLinkRequestSharedLinkPermissions {
        PutWebLinksIdAddSharedLinkRequestSharedLinkPermissions {
            can_download: None,
            can_preview: None,
            can_edit: None,
        }
