...
/// PutFilesIdRequestSharedLinkAllOf : Defines a shared link for an item. Set this to `null` to remove the shared link.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct PutFilesIdRequestSharedLinkAllOf {
    ...
    pub permissions: Option<Box<crate::models::PutFilesIdRequestSharedLinkAllOfPermissions>>,
}

impl PutFilesIdRequestSharedLinkAllOf {
    /// Defines a shared link for an item. Set this to `null` to remove the shared link.
    pub fn new() -> PutFilesIdRequestSharedLinkAllOf {
