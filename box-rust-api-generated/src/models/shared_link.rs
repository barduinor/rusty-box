...
/// SharedLink : Shared links provide direct, read-only access to files or folder on Box.  Shared links with open access level allow anyone with the URL to access the item, while shared links with company or collaborators access levels can only be accessed by appropriately authenticated Box users.
...
impl SharedLink {
    /// Shared links provide direct, read-only access to files or folder on Box.  Shared links with open access level allow anyone with the URL to access the item, while shared links with company or collaborators access levels can only be accessed by appropriately authenticated Box users.
    pub fn new(url: String, effective_access: EffectiveAccess, effective_permission: EffectivePermission, is_password_enabled: bool, download_count: i32, preview_count: i32) -> SharedLink {
        SharedLink {
            url,
            download_url: None,
            vanity_url: None,
