...
/// PutFilesIdAddSharedLinkRequestSharedLink : The settings for the shared link to create on the file. Use an empty object (`{}`) to use the default settings for shared links.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct PutFilesIdAddSharedLinkRequestSharedLink {
    ...
    pub permissions: Option<Box<crate::models::PutFilesIdAddSharedLinkRequestSharedLinkPermissions>>,
}

impl PutFilesIdAddSharedLinkRequestSharedLink {
    /// The settings for the shared link to create on the file. Use an empty object (`{}`) to use the default settings for shared links.
    pub fn new() -> PutFilesIdAddSharedLinkRequestSharedLink {
