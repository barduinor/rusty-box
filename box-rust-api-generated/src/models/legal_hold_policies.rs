...
/// LegalHoldPolicies : A list of legal hold policies.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct LegalHoldPolicies {
    ...
    pub entries: Option<Vec<crate::models::LegalHoldPolicy>>,
}

impl LegalHoldPolicies {
    /// A list of legal hold policies.
    pub fn new() -> LegalHoldPolicies {
        LegalHoldPolicies {
            limit: None,
            next_marker: None,
            prev_marker: None,
