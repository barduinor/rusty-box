...
pub struct FileVersionRetentionWinningRetentionPolicy {
...
impl FileVersionRetentionWinningRetentionPolicy {
    pub fn new(id: String, r#type: RHashType) -> FileVersionRetentionWinningRetentionPolicy {
