...
pub struct IntegrationMappingSlackCreateRequestPartnerItem {
...
impl IntegrationMappingSlackCreateRequestPartnerItem {
    pub fn new(r#type: RHashType, id: String) -> IntegrationMappingSlackCreateRequestPartnerItem {
