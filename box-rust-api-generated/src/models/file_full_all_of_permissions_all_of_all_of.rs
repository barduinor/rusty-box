...
/// FileFullAllOfPermissionsAllOfAllOf : The permissions that the authenticated user has for an item.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct FileFullAllOfPermissionsAllOfAllOf {
...
impl FileFullAllOfPermissionsAllOfAllOf {
    /// The permissions that the authenticated user has for an item.
    pub fn new(can_delete: bool, can_download: bool, can_invite_collaborator: bool, can_rename: bool, can_set_share_access: bool, can_share: bool) -> FileFullAllOfPermissionsAllOfAllOf {
