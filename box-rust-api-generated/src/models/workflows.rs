...
/// Workflows : A list of workflows.  You application must be authorized to use the `Manage Box Relay` application scope within the developer console in order to use this resource.
...
pub struct Workflows {
    ...
    pub entries: Option<Vec<crate::models::Workflow>>,
}
