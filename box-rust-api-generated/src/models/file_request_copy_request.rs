...
/// FileRequestCopyRequest : The request body to copy a file request.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct FileRequestCopyRequest {
    ...
    #[serde(rename = "folder")]
    pub folder: Box<crate::models::FileRequestCopyRequestAllOfFolder>,
}

impl FileRequestCopyRequest {
    /// The request body to copy a file request.
    pub fn new(folder: crate::models::FileRequestCopyRequestAllOfFolder) -> FileRequestCopyRequest {
