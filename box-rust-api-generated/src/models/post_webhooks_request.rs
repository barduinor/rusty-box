...
pub struct PostWebhooksRequest {
    #[serde(rename = "target")]
    pub target: Box<crate::models::PostWebhooksRequestTarget>,
...
impl PostWebhooksRequest {
    pub fn new(target: crate::models::PostWebhooksRequestTarget, address: String, triggers: Vec<Triggers>) -> PostWebhooksRequest {
        PostWebhooksRequest {
