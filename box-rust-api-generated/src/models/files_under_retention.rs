...
/// FilesUnderRetention : A list of files under retention.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct FilesUnderRetention {
    ...
    pub entries: Option<Vec<crate::models::FileMini>>,
}

impl FilesUnderRetention {
    /// A list of files under retention.
    pub fn new() -> FilesUnderRetention {
        FilesUnderRetention {
            limit: None,
            next_marker: None,
            prev_marker: None,
