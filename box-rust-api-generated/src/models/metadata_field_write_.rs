...
/// MetadataFieldWrite : A field within a metadata template. Fields can be a basic text, date, or number field, or a list of options.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct MetadataFieldWrite {
    ...
    pub options: Option<Vec<crate::models::MetadataOptionWrite>>,
}

impl MetadataFieldWrite {
    /// A field within a metadata template. Fields can be a basic text, date, or number field, or a list of options.
    pub fn new(r#type: RHashType, key: String, display_name: String) -> MetadataFieldWrite {
        MetadataFieldWrite {
            r#type,
            key,
            display_name,
