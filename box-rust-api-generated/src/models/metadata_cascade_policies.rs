...
/// MetadataCascadePolicies : A list of metadata cascade policies.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct MetadataCascadePolicies {
    ...
    pub entries: Option<Vec<crate::models::MetadataCascadePolicy>>,
}

impl MetadataCascadePolicies {
    /// A list of metadata cascade policies.
    pub fn new() -> MetadataCascadePolicies {
