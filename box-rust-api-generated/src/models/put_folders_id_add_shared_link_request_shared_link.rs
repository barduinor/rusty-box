...
/// PutFoldersIdAddSharedLinkRequestSharedLink : The settings for the shared link to create on the folder.  Use an empty object (`{}`) to use the default settings for shared links.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct PutFoldersIdAddSharedLinkRequestSharedLink {
...
impl PutFoldersIdAddSharedLinkRequestSharedLink {
    ...
    pub fn new() -> PutFoldersIdAddSharedLinkRequestSharedLink {
