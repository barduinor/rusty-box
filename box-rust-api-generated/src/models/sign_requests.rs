...
/// SignRequests : A standard representation of a sign request, as returned from any Box Sign API endpoints by default.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct SignRequests {
