...
/// FolderFullAllOfPermissionsAllOf : The permissions that the authenticated user has for a folder.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct FolderFullAllOfPermissionsAllOf {
...
impl FolderFullAllOfPermissionsAllOf {
    /// The permissions that the authenticated user has for a folder.
    pub fn new(can_delete: bool, can_download: bool, can_invite_collaborator: bool, can_rename: bool, can_set_share_access: bool, can_share: bool, can_upload: bool) -> FolderFullAllOfPermissionsAllOf {
