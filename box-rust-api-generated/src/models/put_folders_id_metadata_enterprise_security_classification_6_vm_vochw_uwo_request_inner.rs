...
/// PutFoldersIdMetadataEnterpriseSecurityClassification6VmVochwUwoRequestInner : The operation to perform on the classification metadata template instance. In this case, it use used to replace the value stored for the `Box__Security__Classification__Key` field with a new value.
