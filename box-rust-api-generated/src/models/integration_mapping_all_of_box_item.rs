...
/// IntegrationMappingAllOfBoxItem : The Box folder, to which the object from the partner app domain (referenced in `partner_item_id`) is mapped



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct IntegrationMappingAllOfBoxItem {
...
impl IntegrationMappingAllOfBoxItem {
    /// The Box folder, to which the object from the partner app domain (referenced in `partner_item_id`) is mapped
    pub fn new(id: String, r#type: RHashType) -> IntegrationMappingAllOfBoxItem {
