...
/// CollaborationAllowlistExemptTargets : A list of users that is exempt from any of the restrictions imposed by the list of allowed collaboration domains for this enterprise.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct CollaborationAllowlistExemptTargets {
    ...
    pub entries: Option<Vec<crate::models::CollaborationAllowlistExemptTarget>>,
}

impl CollaborationAllowlistExemptTargets {
    ...
    pub fn new() -> CollaborationAllowlistExemptTargets {
