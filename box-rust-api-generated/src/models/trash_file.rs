...
impl TrashFile {
    ...
    pub fn new(id: String, r#type: RHashType, sequence_id: String, sha1: String, description: String, size: i32, path_collection: crate::models::TrashFilePathCollection, created_at: String, modified_at: String, modified_by: crate::models::FileAllOfModifiedBy, owned_by: crate::models::FileAllOfOwnedBy, item_status: ItemStatus) -> TrashFile {
        TrashFile {
            id,
            etag: None,
            r#type,
