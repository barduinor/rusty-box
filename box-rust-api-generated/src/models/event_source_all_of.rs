...
impl EventSourceAllOf {
    pub fn new(id: String, r#type: RHashType, item_type: ItemType, item_id: String, item_name: String) -> EventSourceAllOf {
        EventSourceAllOf {
            id,
            r#type,
            name: None,
