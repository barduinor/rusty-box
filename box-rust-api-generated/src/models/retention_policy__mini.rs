...
/// RetentionPolicyMini : A mini representation of a retention policy, used when nested within another resource.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct RetentionPolicyMini {
