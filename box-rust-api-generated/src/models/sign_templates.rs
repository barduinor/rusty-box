...
/// SignTemplates : A list of templates, as returned from any Box Sign API endpoints by default.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct SignTemplates {
    /// A list of templates.
    #[serde(rename = "entries", skip_serializing_if = "Option::is_none")]
    pub entries: Option<Vec<crate::models::SignTemplate>>,
