...
/// FileFullAllOfPermissionsAllOf : The permissions that the authenticated user has for a file.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct FileFullAllOfPermissionsAllOf {
...
impl FileFullAllOfPermissionsAllOf {
    /// The permissions that the authenticated user has for a file.
    pub fn new(can_delete: bool, can_download: bool, can_invite_collaborator: bool, can_rename: bool, can_set_share_access: bool, can_share: bool, can_annotate: bool, can_comment: bool, can_preview: bool, can_upload: bool, can_view_annotations_all: bool, can_view_annotations_self: bool) -> FileFullAllOfPermissionsAllOf {
        FileFullAllOfPermissionsAllOf {
            can_delete,
            can_download,
