...
/// PutWebLinksIdUpdateSharedLinkRequestSharedLink : The settings for the shared link to update.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct PutWebLinksIdUpdateSharedLinkRequestSharedLink {
    ...
    pub permissions: Option<Box<crate::models::PutWebLinksIdUpdateSharedLinkRequestSharedLinkPermissions>>,
}

impl PutWebLinksIdUpdateSharedLinkRequestSharedLink {
    /// The settings for the shared link to update.
    pub fn new() -> PutWebLinksIdUpdateSharedLinkRequestSharedLink {
