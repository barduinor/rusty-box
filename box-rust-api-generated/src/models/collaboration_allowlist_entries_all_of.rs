...
/// CollaborationAllowlistEntriesAllOf : The part of an API response that describes marker based pagination



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct CollaborationAllowlistEntriesAllOf {
...
impl CollaborationAllowlistEntriesAllOf {
    /// The part of an API response that describes marker based pagination
    pub fn new() -> CollaborationAllowlistEntriesAllOf {
