...
/// CollaborationsAllOf : The part of an API response that describes pagination



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct CollaborationsAllOf {
...
impl CollaborationsAllOf {
    /// The part of an API response that describes pagination
    pub fn new() -> CollaborationsAllOf {
        CollaborationsAllOf {
            total_count: None,
            limit: None,
            offset: None,
