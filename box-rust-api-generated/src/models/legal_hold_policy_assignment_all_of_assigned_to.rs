...
pub struct LegalHoldPolicyAssignmentAllOfAssignedTo {
...
impl LegalHoldPolicyAssignmentAllOfAssignedTo {
    pub fn new(id: String, r#type: RHashType) -> LegalHoldPolicyAssignmentAllOfAssignedTo {
