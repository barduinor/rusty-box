...
pub struct PostGroupMembershipsRequest {
    #[serde(rename = "user")]
    pub user: Box<crate::models::PostGroupMembershipsRequestUser>,
    #[serde(rename = "group")]
    pub group: Box<crate::models::PostGroupMembershipsRequestGroup>,
...
impl PostGroupMembershipsRequest {
    pub fn new(user: crate::models::PostGroupMembershipsRequestUser, group: crate::models::PostGroupMembershipsRequestGroup) -> PostGroupMembershipsRequest {
