...
/// SkillInvocationTokenRead : The basics of an access token



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct SkillInvocationTokenRead {
...
impl SkillInvocationTokenRead {
    /// The basics of an access token
    pub fn new() -> SkillInvocationTokenRead {
