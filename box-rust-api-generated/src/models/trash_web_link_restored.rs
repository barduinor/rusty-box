...
pub struct TrashWebLinkRestored {
    /// `web_link`
    ...
    pub path_collection: Box<crate::models::TrashWebLinkRestoredPathCollection>,
...
impl TrashWebLinkRestored {
    /// Represents a web link restored from the trash.
    pub fn new(sequence_id: String, path_collection: crate::models::TrashWebLinkRestoredPathCollection) -> TrashWebLinkRestored {
