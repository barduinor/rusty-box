...
/// SignRequestBase : A request to create a sign request object



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct SignRequestBase {
...
impl SignRequestBase {
    /// A request to create a sign request object
    pub fn new(parent_folder: crate::models::SignTemplateAllOfParentFolder) -> SignRequestBase {
        SignRequestBase {
