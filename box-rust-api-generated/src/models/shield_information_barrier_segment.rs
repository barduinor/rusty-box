...
pub struct ShieldInformationBarrierSegment {
    ...
    pub created_by: Option<Box<crate::models::ShieldInformationBarrierSegmentCreatedBy>>,
    ...
    pub updated_by: Option<Box<crate::models::ShieldInformationBarrierSegmentUpdatedBy>>,
}
