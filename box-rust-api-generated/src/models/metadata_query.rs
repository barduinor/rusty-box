...
/// MetadataQuery : Create a search using SQL-like syntax to return items that match specific metadata.
...
pub struct MetadataQuery {
    ...
    #[serde(rename = "ancestor_folder_id")]
    ...
    pub order_by: Option<Vec<crate::models::MetadataQueryOrderByInner>>,
...
impl MetadataQuery {
    ...
    pub fn new(from: String, ancestor_folder_id: String) -> MetadataQuery {
        MetadataQuery {
            from,
            query: None,
            query_params: None,
