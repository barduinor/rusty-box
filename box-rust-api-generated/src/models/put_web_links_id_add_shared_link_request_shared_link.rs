...
/// PutWebLinksIdAddSharedLinkRequestSharedLink : The settings for the shared link to create on the web link.  Use an empty object (`{}`) to use the default settings for shared links.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct PutWebLinksIdAddSharedLinkRequestSharedLink {
    ...
    pub permissions: Option<Box<crate::models::PutWebLinksIdAddSharedLinkRequestSharedLinkPermissions>>,
}

impl PutWebLinksIdAddSharedLinkRequestSharedLink {
    ...
    pub fn new() -> PutWebLinksIdAddSharedLinkRequestSharedLink {
