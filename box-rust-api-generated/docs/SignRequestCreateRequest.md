...
**signers** | [**Vec<crate::models::SignRequestCreateSigner>**](SignRequestCreateSigner.md) | Array of signers for the sign request. 35 is the max number of signers permitted. | 
